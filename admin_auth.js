(function () {
    ...
    const TEXT = {
        en: {
            ...
            timeout: 'Session timed out. Please sign in again.'
        },
        'zh-TW': {
            title: '員工專區登入',
            desc: '請輸入員工帳號密碼以繼續。',
    ...
    function resetInactivityTimer() {
        ...
        inactivityTimer = setTimeout(() => {
            ...
            logoutStaff(t.timeout);
        }, INACTIVITY_TIMEOUT_MS);
    }

    function startInactivityTimer() {
        if (inactivityBound || !isAuthed()) return;
